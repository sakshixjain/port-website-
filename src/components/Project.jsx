...
function Project () {
  ...
  <div className="image-item h-[430px]" >
            <figure><img src="ecommerce.png" alt="Cinque Terre" className="image-scroll" /></figure>
              ...
              <p className='text-wrap p-3 text-gray-400'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veritatis deserunt nam ea velit repellendus sequi dolorem fugit accusa aperiam?</p>
...
<div className="image-item h-[450px]" >
          ...
          <div className="image-item h-[485px]" >
           <figure> <img src="calculator.png" alt="Cinque Terre" className="image-scroll" /></figure>
          
              <p className="caption text-[#f54982]">Tip Calculator App</p>
